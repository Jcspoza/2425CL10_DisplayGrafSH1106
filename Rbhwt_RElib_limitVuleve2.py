...
# Programa: basic hw test Rotary Encoder con libreria - Test #2 LIMITE y VUELVE
...
p_project = "Rotary Encoder con libreria - Test #2 - LIMITE y VUELVE"
p_version = "1.0"
...
print('---------------------------')
print('Fin de la inicializacion : RANGE_WRAP')
print('Gira el RE y observa si el contador "steep" va de 0 a 5 y VUELVE A EMPEZAR')
