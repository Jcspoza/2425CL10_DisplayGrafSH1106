...
# Programa: basic hw test Rotary Encoder con libreria - Test #3 LIMITE y PARA
...
p_keyOhw = "Rotary Encoder con libreria - Test #3- RE en pins 16 & 17"
p_project = "Rotary Encoder con libreria - Test #3 - LIMITE y PARA"
p_version = "1.0"
...
print('---------------------------')
print('Fin de la inicializacion : RANGE_BOUNDED')
print('Gira el RE y observa si el contador "steep" va de 0 a 5 y NO AVANZA')
